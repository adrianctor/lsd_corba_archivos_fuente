...
{
	public static void arrancarNS(int prmNumPuertoRmi) throws RemoteException
	{
            try
            {

                Registry registro = LocateRegistry.getRegistry(prmNumPuertoRmi);
                String[] vector=registro.list();
                for (String idNS : vector) {
                    System.out.println("ns : "+idNS );
                }
                System.out.println("El rmiRegistry se ha obtenido y se encuentra escuchando en el puerto: " + prmNumPuertoRmi);

            }
            catch(RemoteException e)
            {
                    System.out.println("El rmiRegistry no se localizó en el puerto: " + prmNumPuertoRmi);

                    Registry registro = LocateRegistry.createRegistry(prmNumPuertoRmi);
                    System.out.println("El rmiRegistry  se ha creado en el puerto: " + prmNumPuertoRmi);
            }
	...
	public static void RegistrarObjetoRemoto(Remote objetoRemoto, String dirIPNS, int numPuertoNS, String identificadorObjetoRemoto)
	{
            ...
            } catch (RemoteException e)
            {
                    ...
                    //TODO: printStackTrace debe ser reemplazado?
                    e.printStackTrace();
