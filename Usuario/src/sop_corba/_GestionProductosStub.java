...
public class _GestionProductosStub extends org.omg.CORBA.portable.ObjectImpl implements sop_corba.GestionProductos
{
  ...
  public sop_corba.GestionProductosPackage.productoDTOCount[] consultarProductos ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("consultarProductos", true);
                $in = _invoke ($out);
                sop_corba.GestionProductosPackage.productoDTOCount $result[] = sop_corba.GestionProductosPackage.ListProductoDTOHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
